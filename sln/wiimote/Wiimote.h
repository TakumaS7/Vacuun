...
typedef std::function<void(const Vector2&)> Vector2Callback;
...
public:
	...
	void onNunchuckJoystick(Vector2Callback callback, bool filterDuplicates = false)
	{
		_nunchuckJoystickCallback = callback;
		_filterNunchuckJoystick = filterDuplicates;
	}
